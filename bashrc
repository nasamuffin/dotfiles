# add ~/bin to PATH
export PATH="/usr/local/google/home/emilyshaffer/bin:$PATH"
# add /usr/games to PATH (for sl)
...
alias tg3='~/git-third/bin-wrappers/git'
alias dbtg3='GIT_DEBUGGER="gdb -tui --args" ~/git-third/bin-wrappers/git'
